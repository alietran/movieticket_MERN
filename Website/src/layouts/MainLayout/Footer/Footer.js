          ...
          <div className="lg:w-1/3">
            ...
            >
              <span className="self-center text-2xl font-semibold top-0">
                <img src="/img/logoFooter.png" className="h-36" />
              </span>
            </a>
          </div>
          <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-3">
            <div className="space-y-4">
              <h3 className="tracking-wide text-white uppercase dark:text-coolGray-50">
                STAR MOVIE
              </h3>
            ...
            <div className="space-y-4">
              <h3 className="uppercase dark:text-coolGray-50 text-white">
                Điều khoản sử dụng
              </h3>
              <ul className={`${style.textColor}`}>
                <li>
            ...
            <div className="space-y-4">
              <div className="uppercase dark:text-coolGray-50 text-white font-bold">
                Mạng xã hội
              </div>
